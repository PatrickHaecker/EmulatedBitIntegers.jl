...
makedocs(;
    modules = [EmulatedBitIntegers],
    authors = "Patrick Häcker <patrick.haecker@de.bosch.com>",
    repo = "https://github.com/PatrickHaecker/EmulatedBitIntegers.jl/blob/{commit}{path}#{line}",
    sitename = "EmulatedBitIntegers.jl",
    format = Documenter.HTML(; canonical = "https://PatrickHaecker.github.io/EmulatedBitIntegers.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/PatrickHaecker/EmulatedBitIntegers.jl")
